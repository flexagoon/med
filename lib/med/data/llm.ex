defmodule Med.Data.LLM do
  ...
  defp build_prompt(drug) do
    ...
    Не используйте Markdown, ваш ответ будет отображен как чистый текст.
    ...
    При этом не нужно быть чрезмерно строгим - если препарат имеет большую доказательную базу, за исключением небольших пробелов, это не делает
    его ненадежным.
